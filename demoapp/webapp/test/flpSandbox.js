		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Trial App",
									"targetURL": "#trialappdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"trialappdemoapp-display": {
								"semanticObject": "trialappdemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=trialapp.demoapp",
									"url": sap.ui.require.toUrl("trialapp/demoapp")
								}
							}
						}
					}
